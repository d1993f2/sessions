...
**Q :** (TK) Comment sauriez-vous sur quoi le régler ? Il faut que ce soit une fréquence super basse ou super haute… (A) Il y a une autre possibilité. Maintenant, quand nous utilisons des [zappeurs](https://fr.wikipedia.org/wiki/Hulda_Regehr_Clark), un courant nous traverse. Quelque chose de ce genre peut-il annuler l’activation des changements physiques générés par ces appareils ?
